...
if __name__ == "__main__":
  try:
    images_dir = "./Cervical_Cell_Nucleus_Master/images/"
    masks_dir  = "./Cervical_Cell_Nucleus_Master/masks/"
    output_dir = "../Cervical-Cell-Nucleus-ImageMask-Dataset/"
