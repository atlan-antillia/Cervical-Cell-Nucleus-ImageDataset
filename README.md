...
Please move to ./generator directory, and run the python script <a href="./generator/ImageMaskDatasetGenerator.py">ImageMaskDatasetGenerator.py</a>.
<pre>
...
<pre>
1 Create 512x512 square images from the original img files in <b>imgbmp</b> folder. 

2 Create 512x512 square masks corresponding to the image files from the original bmp files 
in <b>GroundTruth</b> folder
</pre>
The created <b>Cervical_Cell_Nucleus_Master</b> dataset has the following folder structure.<br>

<pre>
./generator/Cervical_Cell_Nucleus_Master
 ├─images
 └─masks
</pre>
...
Please move to ./generator directory, and run the python script <a href="./generator/split_master.py">split_master.py</a>,
<pre>
